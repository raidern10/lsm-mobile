<x-app-layout title="Tambah Akun Admin">
    <div class="max-w-2xl">
        <h2 class="text-xl font-bold text-gray-800 mb-1">Tambah Akun Admin</h2>
        <p class="text-sm text-gray-500 mb-6">Buat akun administrator baru.</p>

        <form method="POST" action="{{ route('admin.akun-admin.store') }}"
